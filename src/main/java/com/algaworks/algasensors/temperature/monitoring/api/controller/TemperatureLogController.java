...
import com.algaworks.algasensors.temperature.monitoring.api.model.TempetureLogOutput;
...
public class TemperatureLogController {
    ...
    @GetMapping
    public Page<TempetureLogOutput> search(@PathVariable TSID sensorId,
